...
import (
	...
	kotclient "github.com/fgrehm/kot/pkg/kotclient"
...
func (m *MockClient) Reload(ctx context.Context, resource client.Object) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Reload", ctx, resource)
	ret0, _ := ret[0].(error)
	return ret0
}

// Reload indicates an expected call of Reload.
func (mr *MockClientMockRecorder) Reload(ctx, resource interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Reload", reflect.TypeOf((*MockClient)(nil).Reload), ctx, resource)
}
...
// SyncList mocks base method.
func (m *MockClient) SyncList(ctx context.Context, listBefore, listAfter client.ObjectList, processor kotclient.ListSyncProcessFunc) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SyncList", ctx, listBefore, listAfter, processor)
	ret0, _ := ret[0].(error)
	return ret0
}

// SyncList indicates an expected call of SyncList.
func (mr *MockClientMockRecorder) SyncList(ctx, listBefore, listAfter, processor interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SyncList", reflect.TypeOf((*MockClient)(nil).SyncList), ctx, listBefore, listAfter, processor)
}
...
func (m *MockClient) UpdateStatus(ctx context.Context, resource client.Object) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateStatus", ctx, resource)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateStatus indicates an expected call of UpdateStatus.
func (mr *MockClientMockRecorder) UpdateStatus(ctx, resource interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateStatus", reflect.TypeOf((*MockClient)(nil).UpdateStatus), ctx, resource)
}
